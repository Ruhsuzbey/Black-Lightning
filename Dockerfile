...
#Import Gudz
RUN wget https://raw.githubusercontent.com/Ruhsuzbey/Black-Lightning/master/lightningrun.py
RUN wget https://raw.githubusercontent.com/Ruhsuzbey/Black-Lightning/master/requirements.txt
